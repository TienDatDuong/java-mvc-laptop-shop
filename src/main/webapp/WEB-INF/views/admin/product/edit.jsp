        ...
        <main>
            <div class="mx-auto container mt-4">
                <div class="row">
                    ...
                    <form:form method="post" action="/admin/product/edit" modelAttribute="products"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="avatarFile" name="imageFile" accept=".png, .jpg, .jpeg">
                        </div>
                        <span class="mb-3 conten_img">
                            <form:hidden path="image" id="hiddenAvatar" />
